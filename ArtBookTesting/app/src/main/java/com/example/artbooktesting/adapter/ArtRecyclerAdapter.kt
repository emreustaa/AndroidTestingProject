...
class ArtRecyclerAdapter @Inject constructor(val glide: RequestManager) :
    ...
    override fun onBindViewHolder(holder: ArtViewHolder, position: Int) {
        ...
        val nameText = holder.itemView.findViewById<TextView>(R.id.tvArtRowNameText)
        val artistNameText = holder.itemView.findViewById<TextView>(R.id.tvArtistRowNameText)
        val yearText = holder.itemView.findViewById<TextView>(R.id.tvArtRowYearText)
